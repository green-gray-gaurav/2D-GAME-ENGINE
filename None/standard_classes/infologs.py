...
class infoLogbar():
    ...
    def __init__(self ,x , y , textsize , width , showLimit = 5 , switchPos = (10,10)) -> None:
        ...
        self.switchToggle = wid.Button("@" , self.switchPos[0] , switchPos[1] , (255,0,0) , (0,0,0) , textsize , self.__triggerToggle)
        ...
        self.textureback = wid.textureRect(self.x , self.y , self.width , self.logButton.TextRect.height  + self.gap * self.showLimit , borders=[5,5,5,5])
