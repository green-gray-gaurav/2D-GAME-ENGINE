...
class sceneBar():
    def __init__(self , x , y , gap , textWidth , size , navbarLimit = 200 , togglepos =[0,0]):
        ...
        self.createButton = wid.Button("CRT" , x  + self.textWidth + self.deleteButton.TextRect.width  + 5 , y + self.gap,  (200,0,0)  , (200,200,200)  ,self.size , self.__triggerCreateScene )
        self.openButton = wid.Button(">>>" , x  + self.textWidth + self.deleteButton.TextRect.width +5, y + self.gap + self.createButton.TextRect.height,  (0,0,0)  , (200,200,200)  ,self.size , self.__triggerOpenScene )
