...
class quickBar():
    ...
    def renderEvent(self , event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 3 and keypressed[pygame.K_LSHIFT]:
    ...
    def __trigger(self , index):
        ...
        if index == 3:
            ...
            self.inputcommand = wid.textInput(self.pos[0] , self.pos[1] , 200 , 35 )
            self.inputButton = wid.Button("OK" , self.pos[0] + self.inputcommand.width , self.pos[1]  , (200,0,0) , (200,200,200), 30 , trigger=self.setPrefab)
